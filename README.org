...
It fetches 100 memes from [[https://api.imgflip.com/][https://api.imgflip.com]] and picks a random image
displaying the top and bottom text over it.

Here is a preview of what my app looks like:
[[file:src/assets/app-preview.png]]

I built this on my own but took reference of this [[https://www.youtube.com/watch?v=bMknfKXIFA8][react course]].
